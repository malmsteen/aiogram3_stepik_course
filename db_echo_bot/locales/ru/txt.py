RU: dict[str, str] = {
    ...
    "/help": "Я бот, генерирую pdf файлы задач из <b>открытого банка задач ФИПИ</b>, с группировкой по темам, а также отправляю вам обратно ваши сообщения, если они не являются командами!\n\n"
             "Доступные команды:\n\n"
    ...
    "/help_admin": "Я бот, генерирую pdf файлы задач из <b>открытого банка задач ФИПИ</b>, с группировкой по темам. Демострируется также совместная работа реляционной базы данных "
