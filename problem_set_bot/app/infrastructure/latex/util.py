...
Этот файл — часть большого проекта.
...
Иногда я буду выкладывать варианты ОГЭ, следите за обновлениями и качайте, преобретайте подборки. По подборкам ОГЭ решили добавить опцию - преобрести все задачи одного типа по цене 150 рублей (например, все задачи позиции 20) или нескольких типов, соответственно, пропорционально по стоимости.

\begin{figure}[htbp]
	\centering
	\begin{tabular}{cccc}
		% Строка 1 — 4 рисунка
		\includegraphics[scale=0.25]{images/oge_all_qr76922849} & 
		\includegraphics[scale=0.25]{images/oge_1-5_qr76922295} & 
		\includegraphics[scale=0.25]{images/oge_alg-1_qr76922356} & 
		\includegraphics[scale=0.25]{images/oge_geom-1_qr76922401} \\
		\myhref{https://vk.com/market-222480852}{все задачи} & \myhref{https://vk.com/market/product/zadachi-fipi-oge-zadania-1-5-oge-222480852-12700406}{Прикладные задачи 1-5} & \myhref{https://vk.com/market/product/zadachi-fipi-oge-agebra-1-chast-222480852-12713852}{алгебра, I часть} & \myhref{https://vk.com/market/product/zadachi-fipi-oge-geometria-1-chast-222480852-12713898}{геометрия, I часть} \\
		\\
		% Строка 2 — 3 рисунка, последняя ячейка пустая
		\includegraphics[scale=0.25]{images/oge_teorver_qr76922690} & 
		\includegraphics[scale=0.25]{images/oge_alg-2_qr76922761} & 
		\includegraphics[scale=0.25]{images/oge_geom-2_qr76922725} & \\
		\myhref{https://vk.com/market/product/zadachi-fipi-oge-teoria-veroyatnosti-222480852-12713952}{теория вероятности} & \myhref{https://vk.com/market/product/zadachi-fipi-oge-algebra-2-chast-222480852-12714200}{алгебра, II часть} & \myhref{https://vk.com/market/product/zadachi-fipi-oge-geometria-2-chast-222480852-12714579}{геометрия, II часть} & \\
	\end{tabular}
